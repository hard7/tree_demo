...
public:
    ...
    typedef shared_ptr<NodeT> NodeS;
...
void tree_test() {
    ...
    for (auto it = tree.minimum(); it; it = tree.successor(it)) cout << it->key << " ";
    cout << endl;
    ...
    cout << endl;
    for (auto it = tree.maximum(); it; it = tree.predecessor(it)) cout << it->key << " ";
    cout << endl;
